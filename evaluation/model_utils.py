...
def load_hf_lm_and_tokenizer(
        ...
        offload_folder="./offload"  # ✅ NUEVO PARAMETRO
    ):
    import torch 
    ...
    if tokenizer.pad_token is None:
        if tokenizer.unk_token:
            ...
            raise ValueError("El tokenizer no tiene token de padding, unk ni eos.")
    ...
    if gptq_model:
        ...
        model = AutoModelForCausalLM.from_pretrained(
            ...
            device_map=device_map,
            offload_folder=offload_folder,        # ✅ OFFLOAD A DISCO
            offload_state_dict=True,              # ✅ Cargar en disco si es necesario
